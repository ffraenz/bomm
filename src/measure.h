...
static const bomm_measure_string_mapping_t bomm_measure_string_map[] = {
    ...
    { BOMM_MEASURE_IC,                "ic" },
    { BOMM_MEASURE_IC_BIGRAM,         "icBigram" },
    { BOMM_MEASURE_IC_TRIGRAM,        "icTrigram" },
    { BOMM_MEASURE_IC_QUADGRAM,       "icQuadgram" },
    { BOMM_MEASURE_IC_PENTAGRAM,      "icPentagram" },
    { BOMM_MEASURE_IC_HEXAGRAM,       "icHexagram" },
    { BOMM_MEASURE_IC_HEPTAGRAM,      "icHeptagram" },
    { BOMM_MEASURE_IC_OCTAGRAM,       "icOctagram" },
    { BOMM_MEASURE_ENTROPY,           "entropy" },
    { BOMM_MEASURE_ENTROPY_BIGRAM,    "entropyBigram" },
    { BOMM_MEASURE_ENTROPY_TRIGRAM,   "entropyTrigram" },
    { BOMM_MEASURE_ENTROPY_QUADGRAM,  "entropyQuadgram" },
    { BOMM_MEASURE_ENTROPY_PENTAGRAM, "entropyPentagram" },
    { BOMM_MEASURE_ENTROPY_HEXAGRAM,  "entropyHexagram" },
    { BOMM_MEASURE_ENTROPY_HEPTAGRAM, "entropyHeptagram" },
    { BOMM_MEASURE_ENTROPY_OCTAGRAM,  "entropyOctagram" },
